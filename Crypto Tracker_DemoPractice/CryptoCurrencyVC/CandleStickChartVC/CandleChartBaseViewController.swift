//
//  CandleChartBaseViewController.swift
...
class CandleChartBaseViewController: UIViewController, ChartViewDelegate {
...
extension CandleChartBaseViewController: UITableViewDelegate, UITableViewDataSource {
